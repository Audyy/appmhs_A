                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jenis_kelamin">
                            <option value="Laki-Laki" <?= ($data['mahasiswa']['JenisKelamin'] == 'Laki-Laki') ? 'selected' : ''; ?>>Laki-Laki</option>
                            <option value="Perempuan" <?= ($data['mahasiswa']['JenisKelamin'] == 'Perempuan') ? 'selected' : ''; ?>>Perempuan</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Kontak Darurat</label>
                        <input type="text" class="form-control" placeholder="Masukkan kontak darurat..." name="kontak_darurat" value="<?= $data['mahasiswa']['KontakDarurat']; ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="program_studi_id">
                            ...
                            <?php foreach ($data['program_studi'] as $row) : ?>
                                <option value="<?= $row['ProgramStudiID']; ?>" <?= ($data['mahasiswa']['ProgramStudiID'] == $row['ProgramStudiID']) ? 'selected' : ''; ?>><?= $row['NamaProgram']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
