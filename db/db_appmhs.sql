...
(11, 'audy', 'a059a308f61ede557c8219d9564f42c2', '', 'Mahasiswa', NULL);
...
CREATE TABLE `ruang` (
  `RuangID` int NOT NULL,
  `KodeRuang` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Gedung` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `ruang` (`RuangID`, `KodeRuang`, `Gedung`, `Lantai`, `ProgramStudiID`, `Kelas`) VALUES
(6, 'B-2.3', 'B', 2, 1, '5H');
...
ALTER TABLE `ruang`
  ...
  ADD KEY `ruang_ibfk_1` (`ProgramStudiID`);
...
--
ALTER TABLE `dosen`
  MODIFY `DosenID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `matakuliah`
  MODIFY `MataKuliahID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `ruang`
  MODIFY `RuangID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `ruang`
  ADD CONSTRAINT `ruang_ibfk_1` FOREIGN KEY (`ProgramStudiID`) REFERENCES `programstudi` (`ProgramStudiID`);
COMMIT;
